        ...
        <div id="sidebar-wrapper">
            <div class="side-top">
                <div class="logo-sidebar">
                    <a href="index.php"><img src="images/logos/icon.jpg" alt="image" style="width:200px; height:150px;"></a>
                </div>
                                ...
                                <form method="post">
                                    <fieldset class="row-fluid">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                            <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block subt" name="login">Login Now</button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
