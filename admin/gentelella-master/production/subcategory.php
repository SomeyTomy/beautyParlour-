...
$success_message = '';  
 ...
 {  
    ...
    $subcat_image = $_FILES['subcat_image']['name'];
    ...
    $insert_data = array(  
            ...
            'subcat_image' => mysqli_real_escape_string($data->con, $_FILES['subcat_image']['name'])
        );  
     
     // Store the image
        if($data->insert('subcategory', $insert_data))  
        {  
          move_uploaded_file($_FILES['subcat_image']['tmp_name'], $target);
          ...
          <div class="">
           ...
           <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="subcategryform" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="subcat_name" name="subcat_name" class="form-control" pattern="[A-Za-z ]{3,}" title="Invalid Sub Category Name" maxlength="20">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="subcat_price" name="subcat_price" name="subcat_price"  class="form-control" pattern="[0-9]{1,}" title="Invalid Price" maxlength="10">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <textarea name="description" class="form-control" required pattern="[A-Za-z ]{3,}" title="Invalid Sub Category Name" maxlength="250"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="file" id="subcat_image" name="subcat_image" class="form-control">
                      </div>
                    </div>
