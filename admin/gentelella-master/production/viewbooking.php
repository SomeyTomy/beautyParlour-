...
$success_message = '';  
 ...
 {  
    ...
    $insert_data = array(  
            ...
            'subcat_time' => mysqli_real_escape_string($data->con, $_POST['subcat_time']),
...
// $result = $data->getData('booking','*');
$sql = "SELECT * FROM booking INNER JOIN employee ON booking.emp_id = employee.emp_id INNER JOIN time ON booking.time_id=time.id INNER JOIN registration ON booking.reg_id=registration.reg_id";
                          ...
                          $sn = 1;
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                  ...
                                  echo "<td>". $row['stime'] . " to " . $row['etime'] ."</td>";
