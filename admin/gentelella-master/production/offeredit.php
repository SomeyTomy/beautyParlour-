  ...
  $id = 'ofr_id';
   ...
   $arr = $_POST['subcat'];
     ...
     while ($row = mysqli_fetch_assoc($result)) 
      ...
      $temp = 'ofr_id';
      $data->updateData('Offer',$insert_data,$temp,$ofr_id);
...
$result = $data->getData('offer','*',$condition_arr);

// Table Values
$values = $data->getData('offer','*');
// print_r($result);
                  ...
                  <form method="post" name="offerform" id="offerform" action="">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="ofr_name" name="ofr_name" class="form-control" required pattern="[A-Za-z ]{3,}" title="Invalid Offer Name (Only Alphabets and Spaces)" value="<?php echo($values[0]['ofr_name'])?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input id="ofr_sdate" name="ofr_sdate" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required autocomplete="false" value="<?php echo($values[0]['ofr_sdate'])?>">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input id="ofr_edate" name="ofr_edate" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required autocomplete="false" value="<?php echo($values[0]['ofr_edate'])?>">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="ofr-discount" maxlength="2" name="ofr_discount" class="form-control" required pattern="[0-9]{1,2}" title="Invalid Price (Number Only)" value="<?php echo($values[0]['ofr_discount'])?>">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <div class="col-md-6 col-sm-6 offset-md-3">
                        ...
                        <input type="submit" class="btn btn-success" value="save & continue" name="update"/>
                      </div>
                    </div>
